...
func (SnapshotFileInfo_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor21, []int{0, 0} }
...
func (*SnapshotFileInfo) Descriptor() ([]byte, []int) { return fileDescriptor21, []int{0} }
...
func (*SnapshotRegionManifest) Descriptor() ([]byte, []int) { return fileDescriptor21, []int{1} }
...
func (*SnapshotRegionManifest_FamilyFiles) Descriptor() ([]byte, []int) {
	return fileDescriptor21, []int{1, 1}
}
...
func (*SnapshotDataManifest) Descriptor() ([]byte, []int) { return fileDescriptor21, []int{2} }

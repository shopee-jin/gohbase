...
func (TokenIdentifier_Kind) EnumDescriptor() ([]byte, []int) { return fileDescriptor2, []int{1, 0} }
...
func (*AuthenticationKey) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
func (*TokenIdentifier) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1} }
...
func (*Token) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{2} }
...
func (*GetAuthenticationTokenRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{3} }
...
func (*GetAuthenticationTokenResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{4} }
...
func (*WhoAmIRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{5} }
...
func (*WhoAmIResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{6} }
